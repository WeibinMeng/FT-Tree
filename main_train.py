...
if __name__ == "__main__":
    ...
    parser.add_argument('-FIRST_COL', help='FIRST_COL', type=int, default=1)#表示日志数据从第几列开始，若纯logs，则为0
    ...
    parser.add_argument('-remove_middle', help='if 1, delete middle results after training', type=int, default=1)
    ...
    if args.remove_middle:
        print('\n-------deleting middle files---------')
        os.remove(args.fre_word_path)
        print('frequence file is deleted:',args.fre_word_path)
        os.remove(args.middle_templates)
        print('middle templates is deleted:',args.middle_templates)
